...
const KEY_CATEGORY = {
    ...
    POLLINATIONS_INSUFFICIENT_BALANCE: 'quota',

    CONTENT_BLOCKED: 'safety',
    SAFETY_FILTER: 'safety',
    POLLINATIONS_CONTENT_BLOCKED: 'safety',
    POLLINATIONS_BAD_PROMPT: 'safety',
    ...
    POLLINATIONS_SERVER_ERROR: 'server',
    ...
    POLLINATIONS_AUDIO_EMPTY_INPUT: 'validation',
